...
const UUID = process.env.UUID || 'dccd306f-8da7-4ef5-8278-0f465d9ab40b'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'oufd.065678.xyz:80';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'qdyq47bz7Iuzb3UIrbZILgltoiHYHDX8';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
